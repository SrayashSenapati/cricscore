      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "32px 24px" }}>
        ...
        {!loading && searched && players.length === 0 && (
          <div style={{ textAlign: "center", padding: "60px 0" }}>
            ...
            <p style={{ color: "#7d8590" }}>No players found for that search</p>
          </div>
        )}
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
                  ...
                  <div>
                    ...
                    <div style={{ color: "#7d8590", fontSize: "12px", marginTop: "3px" }}>
        ...
        {!searched && (
          <div style={{ textAlign: "center", padding: "60px 0" }}>
            ...
            <p style={{ color: "#7d8590", fontSize: "14px" }}>Type a player name above and hit Search</p>
          </div>
        )}
